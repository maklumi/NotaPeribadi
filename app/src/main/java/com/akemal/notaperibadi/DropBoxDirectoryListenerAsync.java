...
public class DropBoxDirectoryListenerAsync extends AsyncTask<Void, Long, Boolean> {
    ...
    public DropBoxDirectoryListenerAsync(Context context, DropboxAPI<?> api, List<String> directories,
                                         String errorMessage, String currentDirectory, OnLoadFinished listener) {
        mContext = context;
        mApi = api;
    ...
    public DropBoxDirectoryListenerAsync(Context applicationContext, DropboxAPI<AndroidAuthSession> api,
                                         String currentPath, OnLoadFinished onLoadFinished) {
